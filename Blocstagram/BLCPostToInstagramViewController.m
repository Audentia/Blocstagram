...
- (void)viewDidLoad
{
    ...
    [self.filterCollectionView registerClass:[BLCFiltersViewCell class] forCellWithReuseIdentifier:@"cell"];
...
- (UICollectionViewCell*) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    BLCFiltersViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
...
- (void) addFiltersToQueue {
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (colorInvertFilter) {
            ...
            [self addCIImageToCollectionView:colorInvertFilter.outputImage withFilterTitle:NSLocalizedString(@"Spooky", @"Spooky Filter")];
        }
    }];
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (fadeFilter) {
            ...
            [self addCIImageToCollectionView:result withFilterTitle:NSLocalizedString(@"Wasted", @"Wasted Filter")];
        }
    }];
}
